...
\part{Métodos Númericos}
    ...
    \chapter{Factorización LU}
        ...
        \section{Recordemos}
            ...
            Sea $A \in M_{n \times n}$ y tengamos el sistema
            clasico:
            \begin{HugeEq}
                \begin{MultiLineEquation*}{3}
                    A \Color{Indigo700MD}{\vec x} = \vec b
                \end{MultiLineEquation*}
            \end{HugeEq}
            ...
            Si es que pasa alguna de estas entonces diremos que $A$ no es singular.

            Ahora, una forma \Quote{sencilla} de resolver el problema es usando inversas:
            \begin{LargeEq}
                \begin{MultiLineEquation*}{3}
                    \vec x = A^{-1} \vec b
                \end{MultiLineEquation*}
            ...
            Pero el problema es que calcular la inversa de $A$ es muy pesado en cuanto a operaciones
            y sufre muchas veces de problemas de exactitud por las operaciones de punto flotante, así 
            que veamos que otra cosa podemos hacer...
    ...
    \chapter{Análisis del Error}
        ...
        \section{Cotas del Error Absoluto}
            ...
            Entonces decimos que:
            \begin{MultiLineEquation*}{3}
                Error(\vec x) \leq Cond(A) Error(b)
            \end{MultiLineEquation*}
    ...
    \chapter{Solucionar $A \vec x = \vec b$ con $A$ no cuadrada}
        ...
        % ==============================================
        % ====      ES MEJOR QUE NO DECIR NADA      ====
        % ==============================================
        \clearpage
        \section{Sistema de Ecuaciones Normales}
            ...
            \subsection{Función de Error}
                ...
                \begin{SmallIndentation}[1em]
                    ...
                    Y si quieres encontar el minímo basta con solucionar
                    el sistema:
                    \begin{MultiLineEquation*}{3}
