...
\part{Métodos Númericos}
    ...
    \chapter{Factorización LU}
        ...
        \section{Idea del Algoritmo}
            ...
            Sea $\MatrixA \in M_{m \times n}$ que no es singular, entonces tenemos que existe una factorización
            de la forma:
            \begin{LargeEq}
                \begin{MultiLineEquation*}{3}
            ...
            \begin{itemize}
                ...
                \item Soluciona cada nuevo sistema con \Quote{foward substitution}
            \end{itemize}
