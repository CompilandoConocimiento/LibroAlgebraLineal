    ...
    \chapter{Determinantes de $2 \times 2$}
        ...
        \section{Definición}
            ...
            \subsection{N-Lineal}
                ...
                \begin{align*}
                    \delta\pVector{\Brackets{A}^1 \\ \ldots \\ c\Brackets{A}^i + \Brackets{A}^j \\ \ldots \\ \Brackets{A}^m}
                        &= c
                        \delta\pVector{\Brackets{A}^1 \\ \ldots \\ \Brackets{A}^i \\ \ldots \\ \Brackets{A}^m}
                        + \delta\pVector{\Brackets{A}^1 \\ \ldots \\ \Brackets{A}^j \\ \ldots \\ \Brackets{A}^m}
                \end{align*}
            ...
            \begin{itemize}
                ...
                \item
                    ...
                    \begin{SmallIndentation}[1em]
                        ...
                        Igual la idea de la demostración esta sencilla, pero
                        la idea se basa en sacar la $\delta$ de cada uno de los elementos
                        de la base, en este caso es util ver la base:
                        \begin{align*}
                            \Set{
                                \pVector{1&&0\\0&&1}, 
                                \pVector{1&&0\\0&&0},
                        ...
                        Despúes de obtener por propiedades ver que nos dan deltas
                        igual a $1, -1, 0$.

                        Despúes simplemente tienes que expresar a cualquier matriz como
                        combinación lineal de esta base, y usando que $\delta$ en n-lineal
                        llegar a la definición de determinante de $2 \times 2$
