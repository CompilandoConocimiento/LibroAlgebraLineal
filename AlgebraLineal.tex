    ...
    \chapter{Transformaciones Lineales}
        ...
        \section{Definiciones y Características}
            ...
            \subsection{Propiedades}
                ...
                \begin{itemize}
                    ...
                    \item
                        Dados $\VectorSet, \SubVectorSet$ sobre la misma base (y ambos de dimensión finita), entonces y
                        sea $B = \Set{\vec v_1, \dots, \vec v_n}$ base de $\VectorSet$

                        Tomando a otro conjunto $\Set{\vec w_i, \dots, \vec w_n} \subseteq \SubVectorSet$
        ...
        \section{Representación Matricial}
            ...
            \subsection{Representación Matricial}
                ...
                Llamaremos a la matriz $A \in M_{m \times n}(\GenericField)$

                Esta matriz representa a la $\LinTrans$ con respecto a la base ordenada
                $B$ y la escribimos como:
                \begin{align*}
                    A = [\LinTrans]_{B \text{Base del Dominio}}^{\gamma \text{Base del Contradominio}}
                \end{align*}

                Donde la columna j-ésima de $A$ es $\Brackets{\LinTrans{\vec v_j}}_{\gamma}$
